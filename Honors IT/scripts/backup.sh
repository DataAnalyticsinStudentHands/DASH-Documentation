...
rsync -rltP --devices  --exclude='*.Trash/*' --exclude='*Downloads/*' --exclude='*Caches/*' --exclude='*.dmg' --exclude='*Application Support/*' --exclude='.*' --exclude='*Dropbox/*' --exclude='*Google Drive/*' --exclude='*OneDrive*/*' /Users $backuppath/
