...
then
	...
	/usr/bin/curl http://hc-storage.cougarnet.uh.edu/scripts/edu.uh.honors.disablescreenlock.plist -o "/Library/LaunchAgents/edu.uh.honors.disablescreenlock.plist"
	/bin/chmod 644 /Library/LaunchAgents/edu.uh.honors.papercut.plist
fi
