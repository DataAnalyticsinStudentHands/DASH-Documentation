...
|---------------------------------|--------------------------------|-----------------------------------|---------|-----------|----------------------|------------|
| Installs                        | Uninstalls                     | Optional Installs                 | Updates | Catalogs  | Included Manifests   | Conditions |
| gardensxerox.mobileconfig (1.0) | labprinters.mobileconfig (1.0) | Atom (1.6.0) *                    |         | available | allcomputers         |            |
| Sublime Text 3 (3103) *         | PaperCut Client (13.5)         | Spotify (1.0.26.132.ga4e3ccee) *  |         |           |                      ||            |
